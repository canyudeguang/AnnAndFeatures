                                   ...
                                   double viz_factor)
{
    ...
    transpose(visual_image,visual_image);
    return visual_image;

}

cv::Mat_<float> HOGFeatures::getFeature(Mat &image){
    ...
    hog.compute(img_gray,ders,Size(0,0),Size(0,0),locs);



    Mat_<float> feat(1,ders.size());
